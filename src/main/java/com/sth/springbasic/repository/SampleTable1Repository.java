package com.sth.springbasic.repository;
...
// Repository : 해당 클래스를 Spring Bean 으로 등록하는 어노테이션, @Component와 동일
...
public interface SampleTable1Repository
        ...
        // - 기본 CRUD 기능 및 정령 기능 등을 포함
        // - JPA 기반의 Repository를 생성할 땐 필수로 상속해야함
        // - 매개변수 T : 해당 Repository가 어떤 Entity의 Repository인지 지정
        // - 매개변수 ID : 해당 Repository의 Entity의 기본키 타입 지정
